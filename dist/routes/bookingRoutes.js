...
router.get("/", bookingController_1.getBookings); // Query validation happens inside controller
/**
 * @swagger
 * /bookings:
 *   post:
...
router.post("/", (0, validateRequest_1.validateRequest)(bookingValidator_1.createBookingSchema), bookingController_1.createBooking);
/**
 * @swagger
 * /bookings/{id}:
 *   get:
...
router.put("/:id", (0, validateRequest_1.validateRequest)(bookingValidator_1.updateBookingSchema), bookingController_1.updateBooking);
/**
 * @swagger
 * /bookings/{id}:
 *   delete:
