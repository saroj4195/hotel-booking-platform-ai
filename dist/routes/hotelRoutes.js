...
const validateRequest_1 = require("../middleware/validateRequest"); // Middleware to handle Joi validation
...
router.post("/", (0, validateRequest_1.validateRequest)(hotelValidator_1.createHotelSchema), hotelController_1.createHotel); // Validation added
/**
 * @swagger
 * /hotels/{id}:
 *   get:
...
router.put("/:id", (0, validateRequest_1.validateRequest)(hotelValidator_1.updateHotelSchema), hotelController_1.updateHotel); // Validation added
/**
 * @swagger
 * /hotels/{id}:
 *   delete:
