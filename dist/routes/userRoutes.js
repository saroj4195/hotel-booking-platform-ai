 ...
 *         description: Server error
 */
router.put("/profile", authMiddleware_1.protect, (0, validateRequest_1.validateRequest)(userValidator_1.updateUserProfileSchema), userController_1.updateUserProfile);
 ...
 *         description: Server error
 */
router.get("/", authMiddleware_1.protect, authMiddleware_1.admin, userController_1.getUsers); // Query validation in controller
/**
 * @swagger
 * /users/{id}:
 *   get:
 ...
 *         description: Server error
 */
router.put("/:id", authMiddleware_1.protect, authMiddleware_1.admin, (0, validateRequest_1.validateRequest)(userValidator_1.adminUpdateUserSchema), userController_1.updateUser);
/**
 * @swagger
 * /users/{id}:
 *   delete:
