 ...
 */
router.get("/", reviewController_1.getReviews); // Query validation in controller
/**
 * @swagger
 * /reviews:
 *   post:
 ...
 *         description: Server error
 */
router.post("/", authMiddleware_1.protect, (0, validateRequest_1.validateRequest)(reviewValidator_1.reviewSchema), reviewController_1.createReview);
/**
 * @swagger
 * /reviews/{id}:
 *   get:
 ...
 *         description: Server error
 */
router.put("/:id", authMiddleware_1.protect, (0, validateRequest_1.validateRequest)(reviewValidator_1.reviewSchema), reviewController_1.updateReview);
/**
 * @swagger
 * /reviews/{id}:
 *   delete:
 ...
 *         description: Server error
 */
router.delete("/:id", authMiddleware_1.protect, reviewController_1.deleteReview); // Admin check happens in controller
